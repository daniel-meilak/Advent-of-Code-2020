...
long long tree_count(int right, int down, std::vector<std::string>& input);
...
int main(){
    ...
    long long part1 = tree_count(3,1,input);
    long long part2 = tree_count(1,1,input)*part1*tree_count(5,1,input)*tree_count(7,1,input)*tree_count(1,2,input);       
